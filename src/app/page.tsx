...
const TYPING_PHRASES = ["Always Free", "Leiv Method", "0% Loss Quality"];
      ...
      <section className="mx-auto flex max-w-3xl flex-col items-center px-4 pb-24 pt-20 text-center md:pt-28">
        ...
        >
          {[
            ...
            <div
              key={item.label}
              className="flex flex-col items-center gap-1 bg-black/40 px-3 py-5 duration-500 ease-out hover:bg-black/55"
            >
        ...
        <div className="grid gap-4 md:grid-cols-3">
          {[
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: i * 0.15, duration: 0.85, ease }}
